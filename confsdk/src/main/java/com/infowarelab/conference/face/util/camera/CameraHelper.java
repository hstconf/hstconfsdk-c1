package com.infowarelab.conference.face.util.camera;
...
public class CameraHelper implements Camera.PreviewCallback {
    private static final String TAG = "InfowareLab.CameraHelper";
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (supportedPreviewSizes != null && supportedPreviewSizes.size() > 0) {
                    ...
                    Log.d(TAG, "CameraHelper: previewSize=" + previewSize.width + "x" + previewSize.height);
                }
