...
public class ConfigUtil {
    private static final String APP_NAME = "infowarelab.tvbox";
    ...
    private static String mFaceOrientPriority = DetectFaceOrientPriority.ASF_OP_0_ONLY.name();
    ...
    public static void setDefaultFtOrient(DetectFaceOrientPriority ftOrient) {
        mFaceOrientPriority = ftOrient.name();
    }
    ...
    public static DetectFaceOrientPriority getFtOrient(Context context) {
        ...
        SharedPreferences sharedPreferences = context.getSharedPreferences(APP_NAME, Context.MODE_PRIVATE);
        return DetectFaceOrientPriority.valueOf(sharedPreferences.getString(FT_ORIENT, mFaceOrientPriority));
    }
}
