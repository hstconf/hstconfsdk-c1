package com.infowarelab.conference.face.util.face;
...
import com.infowarelab.conference.face.util.TrackUtil;
...
//                    Log.i(TAG, "onPreviewFrame: ft costTime = " + (System.currentTimeMillis() - ftStartTime) + "ms");
                ...
                TrackUtil.keepMaxFaceWithDetectArea(faceInfoList, detectRect);
...
//                        Log.i(TAG, "run: fr costTime = " + (System.currentTimeMillis() - frStartTime) + "ms");
    ...
    public static final class Builder {
        ...
        public Builder detectArea(Rect val) {
            detectRect = val;
            return this;
        }
