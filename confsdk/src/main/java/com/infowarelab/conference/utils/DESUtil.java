...
public class DESUtil {
        ...
        try {
            ...
            for (byte b : messageDigest.digest()) {
                if (Integer.toHexString(0xFF & b).length() == 1) {
                    retBuffer.append("0");
                    retBuffer.append(Integer.toHexString(0xFF & b));
                } else {
                    retBuffer.append(Integer.toHexString(0xFF & b));
                }
            }
    ...
    public static void main(String[] args) throws Exception {
    	String DES_KEY="d7c7e568c4a4e3672c01a5f406e6ef2f";        
         String s="{\"ip\":\"172.16.6.38\",\"uid\":\"9b8d5a02a37644aeb178c87cfe8ce17f\"}";
         System.out.println("加密前的数据："+s.toString());
         System.out.println("DES开始加密......");        
         String enData=encryption(s.toString(), DES_KEY);
         System.out.println("加密后的数据"+enData);
         System.out.println("DES解密后的数据:"+decryption(enData,DES_KEY));
    }
}