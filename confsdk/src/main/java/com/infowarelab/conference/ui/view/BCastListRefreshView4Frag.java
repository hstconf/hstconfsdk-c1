...
public class BCastListRefreshView4Frag extends ListView implements OnScrollListener {
...
//    private ProgressBar progressBar;
    ...
    private int width;
    private int height;
    private BroadcastListAdapter4Frag mAdapter;

    public BCastListRefreshView4Frag(Context context) {
        super(context);
    ...
    public BCastListRefreshView4Frag(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public BCastListRefreshView4Frag(Context context, AttributeSet attrs, int defStyle) {
...
//                .findViewById(R.id.head_progressBar);
    ...
    public void titleLayout(int firstVisiblePosition) {
        ...
        if (mAdapter == null || !(mAdapter instanceof BroadcastListAdapter4Frag)) {
            return;
        }
        int state = 0;
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (adapter instanceof BroadcastListAdapter4Frag) {
            mAdapter = (BroadcastListAdapter4Frag) adapter;
