...
public class HConfListRefreshView4Frag extends ListView implements OnScrollListener {
...
//    private ProgressBar progressBar;
    ...
    public HConfListRefreshView4Frag(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public HConfListRefreshView4Frag(Context context, AttributeSet attrs, int defStyle) {
