...
import com.infowarelab.conference.live.DrawablePaintTextView
...
class LiveMessageImageSpanLevelStrategy : LiveMessageImageSpanStrategy {
    ...
    override fun imageSpan(model: LiveMessageIntrinsicModel, tagTextView: TextView): ImageSpan? {
        model.level?.let {
            ...
            val drawable: Drawable? = ContextCompat.getDrawable(tagTextView.context, R.drawable.live_level_left)
